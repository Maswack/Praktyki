...
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-0ebe321c.js';
import { c as componentOnReady, k as clamp, i as inheritAttributes, s as shallowEqualStringMap } from './helpers-6e1e5b65.js';
...
import { a as attachComponent, d as detachComponent } from './framework-delegate-0e9f0224.js';
import { t as transition } from './index-e6c2c822.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-a895802b.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-3ed8ecec.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-61232da0.js').then(module => module.startInputShims(config));
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import('./swipe-back-f65c5686.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
