...
if (!patched) {
    Module.prototype.require = function () {
        ...
        if (arguments[0].startsWith('@angular-devkit/core')) {
            ...
            readJsonUtils.readJsonWorkspace = (path, host) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                try {
                    ...
                    const w = new workspace_1.Workspaces(app_root_1.appRootPath);
                    // Read our v1 workspace schema
                    const workspaceConfiguration = (0, workspace_1.resolveOldFormatWithInlineProjects)(w.readWorkspaceConfiguration());
