...
export class BishopLessonComponent {
  ...
  positions = "1r6/r7/3B4/8/8/8/8/6r1 w - - 0 1,3r4/4B3/5r2/8/3r4/8/8/6r1 w - - 0 1,1r3r2/r7/7r/8/1B6/r3r3/8/6r1 w - - 0 1"
  lesson = 0;
  moveIndex = 0;
  anwsers = "d6b8,b8a7,a7g1/e7d8,d8f6,f6d4,d4g1/b4a3,a3f8,f8h6,h6e3,e3g1,g1a7,a7b8";
